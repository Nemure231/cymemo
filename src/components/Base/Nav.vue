  ...
  <nav class="flex justify-end bg-cyan-900 sticky top-0 ">
    <div
        ...
        <div v-else class="flex items-center lg:justify-between md:justify-between justify-between lg:space-x-0 md:space-x-0 space-x-0 py-2.5">
            ...
            <input id="edit-judul" readonly v-model="valueGetJudul"  class="lg:w-1/3 md:w-1/2 w-5/6 lg:px-6 lg:py-2 md:px-6 md:py-2 px-2.5 py-2.5  lg:text-lg md:text-lg text-sm  rounded-xl focus:outline-none" type="text" placeholder="Title ..."
