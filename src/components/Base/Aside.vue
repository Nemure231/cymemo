        ...
        <div id="hide-sidebar" class="w-full fixed inset-y-0 overflow-y-auto h-full left-0 bg-cyan-900 lg:w-64 md:w-64">
            <div
                ...
                <div @click="goto" :class="posts.length == 1 ? 'order-1' : 'order-0'" 
                    class="lg:hidden md:hidden cursor-pointer basis-[15%] w-auto h-9 inline-flex items-center justify-center text-2xl font-bold text-white bg-cyan-800 rounded-full">
                    +
                </div>
